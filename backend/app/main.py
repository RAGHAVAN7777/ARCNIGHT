...
from app.auth import AuthLoginRequest, AuthRegisterRequest, AuthRegisterVerifyRequest, login_user, register_user, request_signup_otp, require_authenticated_user
...
@app.post("/auth/register-otp")
def auth_register_otp(
    payload: AuthRegisterRequest,
    supabase_client=Depends(get_supabase_client),
):
    return request_signup_otp(supabase_client, payload)


@app.post("/auth/register")
def auth_register(
    payload: AuthRegisterVerifyRequest,
    supabase_client=Depends(get_supabase_client),
):
